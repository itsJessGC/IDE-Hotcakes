...
151 }*/
        ...
        { 
            ...
            bool isMatch = Regex.IsMatch(palabra, @"\s[a-z]{2}[a-z]*\s", RegexOptions.IgnoreCase);
            if (isMatch)
            {
                    ...
                    while (index < linea.Length)
                    {
                        ...
                        switch (caracter)
                        {
                            ...
                            case '<':
                                ...
                                if (linea[index + 1].Equals('='))
                                {
                                    listar("<=", "TKN_MENOR_QUE", Nolinea);
                                    index++;
                                }
                                else
                                {
                                    listar("<", "TKN_MENOR", Nolinea);
                            ...
                            case '>':
                                ...
                                if (linea[index + 1].Equals('='))
                                {
                                    listar(">=", "TKN_MAYOR_QUE", Nolinea);
                                    index++;
                                }
                                else
                                {
                                    listar(">", "TKN_MAYOR", Nolinea);
                            ...
                            case '=':
                                ...
                                if (linea[index + 1].Equals('='))
                                {
                                    listar("==", "TKN_COMPARA", Nolinea);
                                    
                                    index++;
                                }
                                else
                                {
                                    listar("=", "TKN_IGUALDAD", Nolinea);
        ...
        private static void Arbol()
        {
            ...
            Nodo P = new Nodo(); 
            Nodo h = new Nodo();
            raiz = arbol.Insertar("hola", null);
            arbol.Insertar("como ", raiz);
            P= arbol.Insertar("pao ", raiz);
            arbol.Insertar("? ", P);
             foreach (tokens t in listaTokens)
             {
                 String nombre = t.palabra;
       ;
